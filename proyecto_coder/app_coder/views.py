...
from app_coder.models import Curso,Profesores,Alumno    
from django.template import loader
from app_coder.forms import Curso_formulario, Profesores_formulario , Alumno_formulario
...
def alta_profesores(request):
    ...
    if request.method == "POST":
        ...
        if mi_formulario.is_valid():
            ...
            profesores = Profesores( nombre=datos['nombre'] , Legajo=datos['legajo'])
            profesores.save()
